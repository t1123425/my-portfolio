...
const langData: Langs[] = [
  {
    langType: 'ch',
    text: '中',
    context: `你好! 我叫Tom yuan，我是來自台灣的前端工程師，在網頁開發領域上已有多年經驗，擅長優化網頁使用者體驗與改善網頁執行效能，熟悉網頁前端開發的各種生態工具，曾經手開發過多種線上產品(ex:即時Dashboard系統,客戶形象官網,大型博彩平台等)，
  ...
  },
  {
    ...
    Developed a variety of online products (ex: Real time dashboard system, customer image official website, large game platform, etc.),I like to study and discuss new technologies and willing to help people solve problems. besides being an engineer, I have also served as a teaching assistant for online programming teaching.
